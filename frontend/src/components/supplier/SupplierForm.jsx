...
const SupplierForm = ({ supplier, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (supplier) {
        await axios.put(`https://imssposerp.com/backend/public/api/suppliers/${supplier.id}`, {
        ...
        await axios.post("https://imssposerp.com/backend/public/api/suppliers", {
          supplier_name: supplierName,
          contact,
          address,
        });
...
const SupplierManagement = () => {
  ...
  const fetchSuppliers = async () => {
    try {
      const response = await axios.get("https://imssposerp.com/backend/public/api/suppliers");
  ...
  const confirmDelete = async (id) => {
    try {
      await axios.delete(`https://imssposerp.com/backend/public/api/suppliers/${id}`);
      fetchSuppliers();
