...
const RegisterModal = ({ isOpen, onClose, user }) => {
  const {
    registerStatus,
    openRegister,
    closeRegister,
  ...
  const isClosing = registerStatus.isOpen;
  ...
  useEffect(() => {
    console.log("Register status update:", registerStatus);
  }, [registerStatus]);
  ...
  useEffect(() => {
    if (isClosing && localIsOpen) {
      setInputAmount(registerStatus.cashOnHand?.toString() || "");
      setOtherAmount("");
    } else if (!isClosing && localIsOpen) {
      setInputAmount("");
      setOtherAmount("");
    }
  }, [isClosing, localIsOpen, registerStatus.cashOnHand]);
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="font-medium text-right dark:text-white">
                        LKR {registerStatus.totalSales?.toFixed(2) || "0.00"}
                      </div>
                      <div className="text-gray-600 dark:text-gray-400">
                        Total Quantity:
                      </div>
                      ...
                      <div className="font-medium text-right dark:text-white">
                        LKR {registerStatus.openingCash?.toFixed(2) || "0.00"}
                      </div>
                    </div>
                  </motion.div>
