...
function CreateCompany() {
    ...
    const fetchCompanies = async () => {
        try {
            const response = await axios.get('http://127.0.0.1:8080/api/companies?fields=id,company_name');
    ...
    const fetchCompanyDetails = async (companyName) => {
        try {
            const response = await axios.get(`http://127.0.0.1:8080/api/companies/${companyName}`);
    ...
    const handleSubmit = async (e) => {
        ...
        const url = isEditing
            ? `http://127.0.0.1:8080/api/companies/${selectedCompany}`
    ...
    const handleDeleteCompany = async (companyNameToDelete) => {
        ...
        try {
            const response = await axios.delete(`http://127.0.0.1:8080/api/companies/${companyNameToDelete}`);
