...
function $f6c31cce2adf654f$var$getTouchById(event, pointerId) {
  ...
  for (let i19 = 0; i19 < changedTouches.length; i19++) {
    const touch = changedTouches[i19];
...
function $f6c31cce2adf654f$var$areRectanglesOverlapping(a25, b11) {
  if (a25.left > b11.right || b11.left > a25.right) return false;
  if (a25.top > b11.bottom || b11.top > a25.bottom) return false;
  return true;
}
